...
_lr_productions = [
  ...
  ('existfunc -> <empty>','existfunc',0,'p_existfunc','lexPar.py',532),
  ('startera -> <empty>','startera',0,'p_startera','lexPar.py',541),
  ('fcall1 -> expres generateparam','fcall1',2,'p_fcall1','lexPar.py',546),
  ('fcall1 -> expres generateparam COMA fcall1','fcall1',4,'p_fcall1','lexPar.py',547),
  ('generateparam -> <empty>','generateparam',0,'p_generateparam','lexPar.py',556),
  ('empty -> <empty>','empty',0,'p_empty','lexPar.py',564),
  ('pushcte -> <empty>','pushcte',0,'p_pushcte','lexPar.py',575),
  ('pushid -> <empty>','pushid',0,'p_pushid','lexPar.py',579),
  ('pushop -> <empty>','pushop',0,'p_pushop','lexPar.py',583),
  ('popop -> <empty>','popop',0,'p_popop','lexPar.py',587),
  ('resolverasignacion -> <empty>','resolverasignacion',0,'p_resolverasignacion','lexPar.py',591),
  ('resasignvec -> <empty>','resasignvec',0,'p_resasignvec','lexPar.py',603),
  ('resfact -> <empty>','resfact',0,'p_resfact','lexPar.py',616),
  ('resterm -> <empty>','resterm',0,'p_resterm','lexPar.py',620),
  ('resrel -> <empty>','resrel',0,'p_resrel','lexPar.py',624),
  ('resif -> <empty>','resif',0,'p_resif','lexPar.py',628),
  ('reselse -> <empty>','reselse',0,'p_reselse','lexPar.py',632),
  ('finif -> <empty>','finif',0,'p_finif','lexPar.py',636),
  ('while1 -> <empty>','while1',0,'p_while1','lexPar.py',640),
  ('while2 -> <empty>','while2',0,'p_while2','lexPar.py',644),
  ('while3 -> <empty>','while3',0,'p_while3','lexPar.py',648),
]
